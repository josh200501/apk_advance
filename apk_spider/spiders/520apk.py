...
class _520ApkSpider(CrawlSpider):
    ...
    def parse_item(self,response):
        ...
        size = ''.join(sel.xpath("//div[@class='detail-box']/div[@class='center']/span[@id='view_size']/i[1]/text()").extract())
        item['url'] = ''.join(sel.xpath("//div[@id='downurl']/div[1]/div[2]/ul[1]/li[4]/a[1]/@href").extract())
